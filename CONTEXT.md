...
|---|---|---|---|---|---|
| `check/` | `check/readme.md` | 2026-09-16 | `openspec/specs/check/spec.md` | 2026-09-10 ⚠️ | 2026-09-16 |
| `ctl_worker/` | `ctl_worker/readme.md` | 2026-09-17 | `openspec/specs/ctl-worker/spec.md` | 2026-09-04 ⚠️ | 2026-09-17 |
...
| `plugins/` | `plugins/readme.md` | 2026-09-09 ⚠️ | `openspec/specs/plugins/spec.md` | 2026-09-09 ⚠️ | 2026-09-16 |
| `tfs_kafka/` | `tfs_kafka/README.md` | 2026-09-16 | `openspec/specs/tfs-kafka/spec.md` | 2026-08-31 | 2026-08-28 |
...
| `GP/` | `GP/readme.md` | 2026-09-03 | снимок `HR_Data` @ `279e52a` | 2026-09-10 | 2026-09-10 |

*Собрано 2026-09-17 скриптом `sync_context.py`*

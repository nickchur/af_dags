...
(список OVERRIDABLE). Правятся они формой `export_er_setup`, свёрнутой группой «⚙️ Общие настройки»;
...
# tools-чистильщиков. Правится из формы export_er_setup (свёрнутая группа), значение

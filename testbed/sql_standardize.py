...
Коды выхода:
    0 — успех (возможны предупреждения)
    1 — найдены ошибки валидации (дубли, ERROR-уровень); подавляется через --warn-only
    2 — критическая ошибка ввода (файл не найден, ошибка кодировки, сбой парсинга)
"""
